...
export function SearchBar() {
  return (
    <div className="flex justify-center py-8">
      <div className="flex items-center w-full max-w-3xl bg-white/5 backdrop-blur-sm rounded-lg p-1 border border-white/10 shadow-lg">
        ...
        <Input
          ...
          className="flex-grow bg-transparent p-3 text-white placeholder-white/50 focus-visible:ring-0 border-none h-auto text-lg"
        />
        ...
        <Button 
          ...
          className="bg-pink-600 hover:bg-pink-700 text-white font-medium px-6 py-3 rounded-md transition-colors text-base"
        >
          Pesquisar
        </Button>
      </div>
